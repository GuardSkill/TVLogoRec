...
Usage:
    $ python path/to/train.py --data TVlogoDynamic.yaml --weights yolov5s.pt --img 640
"""
import argparse
import math
import os
...
def run(**kwargs):
    # Usage: import train; train.run(data='TVlogoDynamic.yaml', imgsz=320, weights='yolov5m.pt')
    opt = parse_opt(True)
