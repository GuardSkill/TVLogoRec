...
# print(label_name)
label_name = ['东方卫视', '四川卫视', '云南卫视', '内蒙古卫视', 'CCTV1', 'CCTV13', '凤凰卫视', '安徽卫视', '陕西卫视', 'CCTV10', '星空卫视HD', '重庆卫视',
              '山东卫视', 'CCTV4', '山西卫视', '优漫卡通', 'CCTV5', 'CCTV14', 'CCTV17', '青海卫视', '浙江卫视', 'CCTV9', '黑龙江卫视', '东南卫视',
              'CCTV3', '广西卫视', '宁夏卫视', 'CCTV2', 'CCTV5+', '深圳卫视', '河北卫视', 'CCTV6', '星空卫视', 'CCTV8', '新疆卫视', 'CCTV11',
              '江苏卫视', '天津卫视', '吉林卫视', '湖南卫视', '北京卫视', 'CCTV15', '甘肃卫视', '广东卫视', '湖北卫视', '河南卫视', '江西卫视', '贵州卫视',
              '凤凰卫视HD', 'CCTV16', '金鹰卡通', '辽宁卫视', 'CCTV12', '西藏卫视', 'CCTV7', '厦门卫视', '海南卫视']


#  通过裁剪后的logo图像生成 label-类别 字典对
def generate_class_mapping(dataset_path='/Disk1/Dataset/TV_logo_data/TV_logo_Crop/'):
    ...
    return class_dict, label_name


if __name__ == '__main__':
    #  通过裁剪后的logo图像路径来 生成 label-类别 字典对
    yamlpath = '../yolov5-master/data/TVlogoDynamic.yaml'

    from_data_to_yaml = 0
    if from_data_to_yaml:
        # 从数据文件夹生成 类的配置文件
        label_class, label_name = generate_class_mapping(dataset_path='/Disk1/Dataset/TV_logo_data/TV_logo_Crop/')
    ...
    if label_name is not None and len(label_name) >= 0:
        with open(yamlpath, 'r+') as f:
            ...
            config_dict['nc'] = len(label_name)
            config_dict['names'] = label_name
            config_dict['label_class'] = label_class
            f.seek(0)
            # dump(config_dict,f, sort_keys=False, allow_unicode=True,default_flow_style=True)
